...
class Event {
    ...
    public Event (String key) {
        ...
        this.hour = Utils.currentHour();
        this.dow = Utils.currentDayOfWeek();
    }
    ...
    JSONObject toJSON() {
        ...
        try {
            ...
            if (DclingCloudAgent.getInstance().isLoggingEnabled()) {
                Log.w(DclingCloudAgent.getInstance().TAG, "Got exception converting an Event to JSON", e);
            }
        }
    ...
    static Event fromJSON(final JSONObject json) {
        ...
        try {
            ...
            if (DclingCloudAgent.getInstance().isLoggingEnabled()) {
                Log.w(DclingCloudAgent.getInstance().TAG, "Got exception converting JSON to an Event", e);
            }
            event = null;
        }
